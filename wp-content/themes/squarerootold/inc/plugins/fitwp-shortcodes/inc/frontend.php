...
class FITSC_Frontend
{
	...
	**/
	...
	function icon_box( $atts, $content = null ) {
		...
		*/
		$array = array( 'icon-effect-1' => 'first', 
	...
	function video($atts) {
		...
		else $rnr_video = "<div class='video-embed'><iframe src='http://www.youtube.com/embed/$id?autoplay=$autoplay;HD=1;rel=0;showinfo=0' width='$width' height='$height' class='iframe'></iframe></div>";

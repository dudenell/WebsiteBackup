...
// Set the Options Array
		...
		$of_options[] = array( "name" => "Display Post and Page Settings",
							   "desc" => "",
							   "id"   => "display_settings",
		...
		$of_options[] = array( "name" => "Archive Meta Information",
							   "desc" => "",
							   "id"   => "archiver_info",
...
//General Settings
		...
		$of_options[] = array( "name" => "Sidebar-a width colums",
		...
		$of_options[] = array( "name" => "Sidebar-b width colums",
		 ...
		 * end Squareroottheme
		 */
		$of_options[] = array( "name" => "Page/Post Options",
							   "type" => "heading",
							   "icon" => ADMIN_IMAGES . "icon-header.png"
		);
		$url          = ADMIN_DIR . 'assets/images/';
		$of_options[] = array( "name"    => "Page/Post Layout",
							   //"desc"    => "Select main content and sidebar alignment. Choose between 1, 2 or 3 column layout.",
							   "id"      => "pp_layout",
							   "std"     => "2c-l-fixed",
							   "type"    => "images",
		...
		$of_options[] = array( "name" => "Copyright Text",
							   ...
							   "id"   => "footer_text",
							   "std"  => "&copy; [Y] Square Root &#8226; Built by obTheme.<br/>Premium WordPress Themes by obTheme.",
							   "type" => "textarea"
		);
...
// typofraphy
		...
		$of_options[] = array( "name"    => "Select Font Family",
...
// css custom
		...
		$of_options[] = array( 	"name" 		=> "Google Map Settings",
								"type" 		=> "heading",
		...
		$of_options[] = array( "name" => "Button color ",
							   ...
							   "std"  => "#151d2a",
							   "type" => "color" );
		$of_options[] = array( "name" => "Button hover color ",

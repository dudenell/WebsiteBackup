...
function squareroot_scripts() {
	...
	if ( isset( $squareroot_data['font_awesome'] ) && $squareroot_data['font_awesome'] == 'font_awesome_cdn' ) { 
		wp_enqueue_style( 'fontawesome', 'https://netdna.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.css' ); 
	} else { 
	...
	wp_enqueue_script( 'infobox', get_template_directory_uri() . '/js/infobox.js', array(), '', true );
